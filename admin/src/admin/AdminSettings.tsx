  ...
  return (
    <div>
      ...
      <form onSubmit={submit} className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-4">
        <h2 className="text-lg font-semibold text-slate-800">Brand & Footer</h2>
        ...
        {/* Footer editing moved to Contact Page */}

        <h2 className="text-lg font-semibold text-slate-800 pt-4 border-t border-slate-200">Social Links</h2>
